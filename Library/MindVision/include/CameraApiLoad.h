...
typedef    CameraSdkStatus (__stdcall *_CameraSetCallbackFunctionEx)(
	CameraHandle        hCamera,
	CAMERA_SNAP_PROC    pCallBack,
	PVOID               pContext,
	CAMERA_SNAP_PROC*   pCallbackOld,
...
typedef    CameraSdkStatus (__stdcall *_CameraSetGrabExceptionHandler)(
	CameraHandle        hCamera,
...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
typedef    CameraSdkStatus (__stdcall *_CameraGetDevTimeStamp)(
	CameraHandle    hCamera,
	UINT*			pTimeStampL32,
	UINT*			pTimeStampH32
	);
...
EXTERN _CameraSetCallbackFunctionEx CameraSetCallbackFunctionEx;

EXTERN _CameraSetGrabExceptionHandler CameraSetGrabExceptionHandler;
...
EXTERN _CameraGetDevTimeStamp CameraGetDevTimeStamp;
...
#define GET_MVSDK_API(name)			\
	...
	GET_MVSDK_API(CameraSetCallbackFunctionEx);
	GET_MVSDK_API(CameraSetGrabExceptionHandler);
	...
	GET_MVSDK_API(CameraGetDevTimeStamp);
