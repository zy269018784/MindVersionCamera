// CVmProcedureControlInterface.h : 由 Microsoft Visual C++ 创建的 ActiveX 控件包装器类的声明

#pragma once

/////////////////////////////////////////////////////////////////////////////
// CVmProcedureControlInterface

class CVmProcedureControlInterface : public CWnd
{
protected:
	DECLARE_DYNCREATE(CVmProcedureControlInterface)
public:
	CLSID const& GetClsid()
	{
		static CLSID const clsid
			= { 0x4919FA4C, 0xF224, 0x4C1E, { 0x91, 0x7C, 0x89, 0xB7, 0xF3, 0x7A, 0xAE, 0x90 } };
		return clsid;
	}
