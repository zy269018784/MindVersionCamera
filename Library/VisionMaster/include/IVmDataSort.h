/***************************************************************************************************
 * File：IVmDataSort.h
 * Note：@~chinese 排序模块模块接口声明 @~english Interface for the DataSort tool.
 *
 ***************************************************************************************************/
#ifndef _IVM_DATASORT_H_
#define _IVM_DATASORT_H_
...
namespace VisionMasterSDK
{
    ...
    /// @{
        /*************************** Params Class Start ***************************/
        /*  Note: Interface Classes of the parameter of the DataSortParams.  */
        ///排序模块参数类
        class DataSortParams : public CModuParamsBase
        {
        protected:
            ///< Constructor and Destructor
            explicit DataSortParams() {}
            virtual ~DataSortParams() {}
        ...
        /*************************** Results Class Start ***************************/
        /*  Note: Interface Classes of the result of the DataSortResults.  */
        ///排序模块结果类
        class DataSortResults : public CModuleResultBase
        {
        protected:
            ///< Constructor and Destructor
            explicit DataSortResults() {}
            virtual ~DataSortResults() {}
        ...
        /*************************** Tool Class Start ***************************/
        /*  Note: Note: This is the class for the DataSort tool.  */
        ///排序模块工具类
        class DataSortModuleTool : public CVmToolBase
        {
        protected:
            ///< Constructor and Destructor
            explicit DataSortModuleTool() {}
            virtual ~DataSortModuleTool() {}
        ...
        public:
             ...
             * @remarks 禁止使用参数基类的方法
             */
            virtual DataSortParams* GetParamObj() = 0;

            /**
             * @brief 查找结果
             * @return 未执行或执行失败，返回NULL
             */
            virtual DataSortResults* GetResult() = 0;
        ...
        private:
            DataSortModuleTool(DataSortModuleTool&);
            DataSortModuleTool& operator=(DataSortModuleTool&);
        };
        /*************************** Tool Class End ***************************/
    /// @}
    }
}
#endif    ///< _IVM_DATASORT_H_
