/***************************************************************************************************
 * File：IVmIMVSCnnHPRegisterDetect.h
 * Note：@~chinese 高精度注册检测模块接口声明 @~english Interface for the IMVSCnnHPRegisterDetect tool.
 *
 * Version：4.4
 * Date: 2023-11-13 14:43:42
 ***************************************************************************************************/
#ifndef _IVM_CnnHPRegisterDETECT_H_
#define _IVM_CnnHPRegisterDETECT_H_
...
{
    namespace IMVSCnnHPRegisterDetectModu
    {
        ...
        typedef enum _OrderTypeEnum
        {
            ...
            /// @~chinese 按置信度降序   @~english Sort by Score High to low
            OrderType_Score = 0x3,
    ...
    /// @{
        ...
        ///高精度注册检测ROI管理类
        class CnnHPRegisterDetectRoiManager
        {
        public:
        ...
        /*  Note: Interface Classes of the parameter of the IMVSCnnHPRegisterDetectParams.  */
        ///高精度注册检测C参数类
        class IMVSCnnHPRegisterDetectParams : public CModuParamsBase
        {
        protected:
            ///< Constructor and Destructor
            explicit IMVSCnnHPRegisterDetectParams() {}
            virtual ~IMVSCnnHPRegisterDetectParams() {}
        ...
        public:
            ...
            virtual CnnHPRegisterDetectRoiManager* GetModuRoiManager() = 0;

            /// @~chinese 最大查找个数，范围：[1,10000]   @~english Max Number to Find，range:[1,10000]
            ...
            /// @~chinese 面积范围，范围：[1,1600000000]   @~english AreaRange，range:[1,1600000000]
        ...
        /*************************** Results Class Start ***************************/
        /*  Note: Interface Classes of the result of the IMVSCnnHPRegisterDetectResults.  */
        ///高精度注册检测结果类
        class IMVSCnnHPRegisterDetectResults : public CModuleResultBase
        {
        protected:
            ///< Constructor and Destructor
            explicit IMVSCnnHPRegisterDetectResults() {}
            virtual ~IMVSCnnHPRegisterDetectResults() {}
        ...
        /*************************** Tool Class Start ***************************/
        /*  Note: Note: This is the class for the IMVSCnnHPRegisterDetect tool.  */
        ///高精度注册检测工具类
        class IMVSCnnHPRegisterDetectModuTool : public CVmToolBase
        {
        protected:
            ///< Constructor and Destructor
            explicit IMVSCnnHPRegisterDetectModuTool() {}
            virtual ~IMVSCnnHPRegisterDetectModuTool() {}
        ...
        public:
             ...
             */
            virtual IMVSCnnHPRegisterDetectParams* GetParamObj() = 0;

            /**
             * @brief 查找结果
             * @return 未执行或执行失败，返回NULL
             */
            virtual IMVSCnnHPRegisterDetectResults* GetResult() = 0;
        ...
        private:
            IMVSCnnHPRegisterDetectModuTool(IMVSCnnHPRegisterDetectModuTool&);
            IMVSCnnHPRegisterDetectModuTool& operator=(IMVSCnnHPRegisterDetectModuTool&);
        };
        /*************************** Tool Class End ***************************/
    /// @}
    }
}
#endif    ///< _IVM_CnnHPRegisterDetect_H_
