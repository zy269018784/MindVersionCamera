 ...
 * Note：@~chinese 灰度匹配模块接口声明 @~english Interface for the GrayMatchVA tool.
 *
 ***************************************************************************************************/
...
namespace VisionMasterSDK
{
    ...
    /// @{
        ...
        public:
            ...
            /// @~chinese 最小匹配分数，范围：[0,1]   @~english Min Match Score，range:[0,1]
            ...
            /// @~chinese 匹配极性，范围：[0,1]   @~english Match Polarity，range:[0,1]
            ...
            /// @~chinese 匹配结束层，范围：[0,8]   @~english EndPyramidLevel Feature，range:[0,8]
